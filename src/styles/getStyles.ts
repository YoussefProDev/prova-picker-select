...
// Definiamo un tipo che rappresenta la struttura degli stili
export type defaultStyle = {
  ...
  commonName: TextStyle;
  commonSymbolCode: TextStyle;
  search: ViewStyle;
  textInputContainer: ViewStyle;
  textTitleSmallerWhite: TextStyle;
  textInput: TextStyle;
  searchClose: ViewStyle;
  listNullContainer: ViewStyle;
  header: ViewStyle;
...
// Funzione che restituisce gli stili mappati
export const getStyles = (darkTheme = false): defaultStyle => {
